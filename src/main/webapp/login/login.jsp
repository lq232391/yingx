    ...
    <script>
        $(function(){
            ...
            $.extend($.validator.messages, {
                required: "<span style='color: #db4865'>必须输入</span>",  //提示信息
                minlength: $.validator.format("<span style='color: #4cae4c'>输入不小于3</span>")
            });
            //提交表单
            $("#loginButtonId").click(function(){
                ...
                if(ok){
                    $.ajax({
                        url:"${path}/admin/login",//跳转的地址
                        type:"post",//以什么方式提交
                        data:$("#loginForm").serialize(),//序列化
                        dataType:"JSON",//转化为JSON格式
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <input minlength="4" type="text" name="code" style="width: 289px;height: 50px;border:3px solid #ddd;border-radius: 4px;" required >
                            </div>
